...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-navy-950 flex flex-col justify-between text-white selection:bg-accent selection:text-white">
      ...
      <main className="flex-1 flex items-center justify-center py-28 px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          {/* 404 Badge */}
          <div className="inline-flex items-center gap-2 mb-6 px-3.5 py-1.5 rounded-full border border-red-500/30 bg-red-500/10 text-red-400 text-xs font-semibold uppercase tracking-wider">
            <span className="w-2 h-2 rounded-full bg-red-400 animate-pulse" />
            Error 404 — Page Not Found
          </div>

          {/* Headline */}
          <h1 className="text-5xl sm:text-7xl font-extrabold text-white tracking-tight mb-4 leading-tight">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-accent hover:bg-accent-dark text-white font-semibold text-sm transition-all duration-200 shadow-sm hover:shadow-accent-glow"
            >
            ...
            <Link
              href="/#platform"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-navy-900 border border-white/15 hover:border-white/30 text-white font-semibold text-sm transition-all duration-200"
            >
              Explore Platform
            </Link>
          </div>
          ...
          <div className="bg-navy-900/60 border border-white/10 rounded-2xl p-6 sm:p-8 text-left backdrop-blur-sm">
