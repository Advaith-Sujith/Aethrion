...
const steps = [
  {
    ...
    description:
      "Customers reach out through voice, chat, WhatsApp, email, or social channels. Aethrion CX receives the interaction and immediately begins analysis.",
    icon: (
          ...
          {steps.map((step, i) => (
            <RevealOnScroll key={step.number} delay={i * 80}>
              <div className="relative group h-full">
                ...
                <div className="bg-navy-900 border border-white/10 rounded-2xl p-6 h-full hover:border-white/20 transition-all duration-300 hover:-translate-y-1">
