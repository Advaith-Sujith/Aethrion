...
const differentiators = [
  {
    ...
    label: "CCaaS + CPaaS",
    description:
      "Full-stack contact center and communications capabilities in one integrated platform.",
    badge: "Full-stack",
  },
  {
    icon: (
    ...
    label: "Multilingual Conversational Bots",
    description:
      "AI-powered voice bots supporting 70+ languages — including 12 Indian languages — with contextual memory.",
    badge: "70+ Languages",
  },
  {
    icon: (
    ...
    label: "Build Once, Deploy Anywhere",
    description:
      "Create a workflow or bot once and deploy it across all supported channels without rebuilding.",
    badge: "Omnichannel",
  },
  {
    icon: (
    ...
    description:
      "Real-time emotion detection across voice and text with 85% accuracy — supporting escalation prevention and proactive coaching.",
    badge: "85% Accuracy",
  },
  {
    icon: (
    ...
    description:
      "Monitor brand mentions across social channels, identify emerging issues, and trigger automated response workflows.",
  ...
  },
  {
    ...
    label: "AI Reporting & Analytics",
    description:
      "Automated insights, predictive CSAT scoring, configurable dashboards, and workforce optimization reporting.",
    badge: "Predictive",
  },
  {
    icon: (
    ...
    description:
      "Connect customer interactions with backend transactions and business processes through a visual workflow builder.",
  ...
  },
  {
    ...
    description:
      "Real-time suggested responses, interaction summarization, and next-best actions powered by generative AI.",
    badge: "GenAI",
  },
];
